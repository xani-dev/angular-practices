...
*/
const users = {
  "xani@tpdsrobotshop.com": {
    firstName: "Xani",
    lastName: "Pink",
    email: "xani@tpdsrobotshop.com",
    password: "very-secret",
  },
  "tpd@tpdsrobotshop.com": {
    firstName: "The Pink",
    lastName: "Dev",
    email: "tpd@tpdsrobotshop.com",
...
/* IMPORTANT:
    ...
    practices. In a production application user credentials would be encrypted in 
    a database server and the password should NEVER be stored as plain text. 
*/
